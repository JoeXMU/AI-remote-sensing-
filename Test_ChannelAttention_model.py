...
class ChannelAttention(nn.Module):
    def __init__(self, num_features, reduction_ratio=16):
        ...
        # 通道注意力的两个全连接层
        self.fc1 = nn.Linear(num_features, 17)
        self.fc2 = nn.Linear(17, num_features)
...
class Net(nn.Module):
    def __init__(self, in_channels, hid_channels1, hid_channels2, hid_channels3, hid_channels4, hid_channels5,
                 out_channels):
...
if __name__ == '__main__':
    ...
    net = torch.load('MPL+attention.pth')
    # 获取文件夹中所有的 .npy 文件
    ...
    import joblib
    robust_scaler = joblib.load('MPL+attention.pkl')
