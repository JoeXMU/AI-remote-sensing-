# @File : cOMBINEDrESNET_feature_selection.py
# @Time : 2024/5/29 20:26
# @Author : Qiao Hanyang
...
if __name__ == '__main__':
    ...
    filtered_box.iloc[:, :20] = robust_scaler.fit_transform(filtered_box.iloc[:, :20])

    # 保存 RobustScaler 对象
    joblib.dump(robust_scaler, 'Remove ear5.pkl')
    ...
    torch.save(net, "Remove ear5.pth")
    """可视化"""
